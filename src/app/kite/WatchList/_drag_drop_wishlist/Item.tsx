...
function Item({
  ...
  return (
    ...
    >
      <div
        className={twMerge(
          " relative flex border-y border-borderApp p-[12px_15px] hover:bg-lightGrayApp ",
          getColor(diff),
        )}
      ...
      >
        ...
        <div className="flex w-full">
          ...
          <div
            className={twMerge(
              "  absolute  right-0 top-0 hidden  h-full gap-[2px] p-[8px_15px_8px_2px] text-foreground ",
              isHover && " flex ",
            )}
